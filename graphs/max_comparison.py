...
#exec(open('graphs/max_comparison.py').read())
...
ax.plot(x_axis, [gaussian_inv_cdf(1, 0, (x-1)/x) for x in x_axis], color='purple',linestyle='solid', label='odds estimate: Φ⁻¹((x-1)/x)')
